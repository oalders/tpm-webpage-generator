...
TPM::WebSite::Calendar - The great new TPM::WebSite::Calendar!
...
Perhaps a little code snippet.
    ...
    use TPM::WebSite::Calendar;

    my $foo = TPM::WebSite::Calendar->new();
    ...
